...
public class MapActivityKategoriHotel extends AppCompatActivity implements OnMapReadyCallback {
  ...
  private void getAllDataLocationLatLng() {
    ...
    Call<RekomModel> call = mApiServices.rekomkategori(1);
  ...
  public void onBackPressed(){
    super.onBackPressed();
    Intent i = new Intent(MapActivityKategoriHotel.this,ListHotelActivity.class);
    startActivity(i);
    finish();
  }
