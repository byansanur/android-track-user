...
public class MapActivityKategoriKuliner extends AppCompatActivity implements OnMapReadyCallback {
  ...
  private void getAllDataLocationLatLng() {
    ...
    Call<RekomModel> call = mApiServices.rekomkategori(2);
  ...
  public void onBackPressed(){
    super.onBackPressed();
    Intent i = new Intent(MapActivityKategoriKuliner.this,ListKulinerActivity.class);
    startActivity(i);
    finish();
  }
