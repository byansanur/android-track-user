...
import com.byandev.trackusers.Adapter.AdapterRekomListTravel;
...
import com.byandev.trackusers.Main.MapActivityKategoriTravel;
...
public class FragmentListTravel extends Fragment {
  ...
  private AdapterRekomListTravel adapter;

  public FragmentListTravel(){
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle s) {
    ...
    adapter = new AdapterRekomListTravel(getContext(), rekomArrayList);
  ...
  public void onStart(){
    ...
    floatingActionButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        startActivity(new Intent(context, MapActivityKategoriTravel.class)
...
//        Intent a = new Intent(FragmentListHotel.this, )
  ...
  private void firstLoad() {
    ...
    mApiService.rekomList(3, limit, 0).enqueue(new Callback<RekomModel>() {
      @Override
  ...
  private void loadMore() {
    itShouldLoadMore = false;
    mApiService.rekomList(3, limit, offset).enqueue(new Callback<RekomModel>() {
      @Override
      public void onResponse(Call<RekomModel> call, Response<RekomModel> response) {
        if (response.isSuccessful()) {
          itShouldLoadMore = true;
