...
public class AdapterRekomListKuliner extends RecyclerView.Adapter<AdapterRekomListKuliner.ViewHolder> {
  ...
  public AdapterRekomListKuliner(Context context, List<RekomModel.Rekom> rekomList){
  ...
  @NonNull
  @Override
  public AdapterRekomListKuliner.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rekom_kuliner, null);
    mApiService = UtilsApi.getAPIService();
    sharedPrefManager = new SharedPrefManager(context);
    return new AdapterRekomListKuliner.ViewHolder(view);
  }

  @Override
  public void onBindViewHolder(@NonNull AdapterRekomListKuliner.ViewHolder holder, int position) {
